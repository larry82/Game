...
ActiveRecord::Schema.define(version: 20170124113422) do
  ...
  add_index "item_effects", ["item_id"], name: "index_item_effects_on_item_id"
  ...
  create_table "lv_managements", force: :cascade do |t|
    t.integer  "level"
